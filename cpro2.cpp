...
int main() {
    ...
    fclose(fp);                        // 파일 닫기
    float cpro_avg = (students[0].cpro + students[1].cpro + students[2].cpro) / 3.0;          //c 프로그래밍 평균 성적 구하기
    float webpro_avg = (students[0].webpro + students[1].webpro + students[2].webpro) / 3.0;  //웹 프로그래밍 평균 성적 구하기
